        ...
        <section id = "contact" className = "relative" >
            <div className = "container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap" >
                <div className = "lg:w-2/3 md:w-1/2 bg-gray-800 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative" >
                    ...
                    src = "https://www.google.com/maps/embed/v1/place?q=Dallas,+GA,+USA&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" />
                    <div className = "bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md" >
                        <div className = "lg:w-1/2 px-6" >
                            <h2 className = "title-font font-semibold text-white tracking-widest text-xs" >ADDRESS </h2> 
                            <p className = "mt-1" >Dallas, GA 30132 </p>
                            <h2 className = "title-font font-semibold text-white tracking-widest text-xs mt-4 pt-6" >SOCIALS</h2>
                            <SocialIcon url="https://www.linkedin.com/in/barbara-kuffuor/" style={{ height: 25, width: 25 }}/>
                            <SocialIcon url="https://github.com/bkf1at/"    style={{ height: 25, width: 25}}/>
                        ...
                        <div className = "lg:w-1/2 px-6 mt-4 lg:mt-0" >
                            ...
                            <a className = "text-purple-400 leading-relaxed" >bkarikarikuffuor @yahoo.com </a> 
                            <h2 className = "title-font font-semibold text-white tracking-widest text-xs mt-4" >PHONE </h2> 
                            <p className = "leading-relaxed" > 646 - 719 - 7091 </p> 
                        </div > 
                    </div> 
                </div> 
      ...
      <button className = "text-white text-xl mb-1 hover:bg-purple-400 rounded-full font-small title-font">
        Freelance Services
                    ...
                    <div className = "relative mb-4" >
                        ...
                        <textarea id = "message" name = "message" className = "w-full bg-gray-800 rounded border border-gray-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-900 h-32 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                        onChange = {(e) => setMessage(e.target.value)}/> 
                    </div> 
                    <button type = "submit" className = "text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded text-lg" >Submit </button> 
                    </form > 
            </div> 
            </section >
    );
